...
IL_000a:
	{
		bool L_1;
		L_1 = AsyncGPUReadbackRequest_get_done_mC042016E5BE850F18995831CBB4F06655914798C((&___1_request), NULL);
		if (!L_1)
		{
			goto IL_0024;
		}
	}
	{
		...
		L_2 = AsyncGPUReadbackRequest_GetData_TisByte_t94D9231AC217BE4D2E004C4CD32DF6D099EA41A3_mC365851AEF03CCC25905B4A8808B40AB3969C136((&___1_request), 0, AsyncGPUReadbackRequest_GetData_TisByte_t94D9231AC217BE4D2E004C4CD32DF6D099EA41A3_mC365851AEF03CCC25905B4A8808B40AB3969C136_RuntimeMethod_var);
		V_0 = L_2;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SerializationHelpers_WriteRenderTexture_m6437632AC238973D1DE07533E527480505A3BE35 (CommandBuffer_tB56007DC84EF56296C325EC32DD12AC1E3DC91F7* ___0_cmd, String_t* ___1_path, RenderTexture_tBA90C4C3AD9EECCFDDCC632D97C29FAB80D60D27* ___2_renderTex, const RuntimeMethod* method) 
{
	//<source_info:<no-source>:1>
	{
		...
		RenderTexture_tBA90C4C3AD9EECCFDDCC632D97C29FAB80D60D27* L_1 = ___2_renderTex;
		RenderTargetIdentifier_tA528663AC6EB3911D8E91AA40F7070FA5455442B L_2;
		L_2 = RenderTargetIdentifier_op_Implicit_mBF13C6AE62DCEDDEFDC1C7305BE646FE99D2F24C(L_1, NULL);
		...
		SerializationHelpers_WriteRenderTexture_m2F82B0037C93427993C21E137517ED42A41584A2(L_0, L_2, ((int32_t)20), L_4, L_6, L_7, NULL);
		return;
	}
}
#ifdef __clang__
